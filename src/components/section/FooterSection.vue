<template>
  <footer class="bg-black text-white pt-16 pb-8 border-t border-gray-800">
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-4 gap-8 mb-12">
        ...
        <div class="space-y-4">
          ...
          <p class="text-gray-400 pr-4">
            We create digital experiences that stand out and deliver results for our clients worldwide.
          </p>
        ...
        <!-- Quick Links -->
        <div>
          <h3 class="text-lg font-semibold mb-4 bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent inline-block">Quick Links</h3>
          <ul class="space-y-2">
        ...
        <!-- Services -->
        <div>
          <h3 class="text-lg font-semibold mb-4 bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent inline-block">Our Services</h3>
          <ul class="space-y-2">
        ...
        <!-- Newsletter -->
        <div>
          <h3 class="text-lg font-semibold mb-4 bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent inline-block">Stay Updated</h3>
          ...
          <form @submit.prevent="subscribeToNewsletter" class="space-y-3">
            <div class="relative">
              <input
                ...
                class="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
              >
            </div>
            <button
              type="submit"
              class="w-full px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 rounded-md font-medium transition-colors"
            >
              Subscribe
            </button>
          </form>
      ...
      <!-- Bottom Footer -->
      <div class="pt-8 border-t border-gray-800 flex justify-between items-center">
        <p class="text-gray-500 text-sm">
          © {{ new Date().getFullYear() }} workerharder. All rights reserved.
        </p>
